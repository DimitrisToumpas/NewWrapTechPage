...
const TESTIMONIALS = [
  {
    ...
    initials: "MC",
    rating: 5,
    text: "WrapTech transformed my F8 with a satin Frozen Black wrap. The attention to detail is unmatched — every panel is perfect. My car stops traffic wherever it goes.",
    color: "#C9A84C",
  },
  {
    name: "Sophia Laurent",
...
const PORTFOLIO_ITEMS = [
  ...
  { id: 5, label: "Midnight Purple GT-R", tag: "Wrap", tall: false, hue: "18,18,18" },
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center" }}>
          <div style={{
            width: 120, height: 60, margin: "0 auto 1rem",
            background: "linear-gradient(90deg, #C9A84C 0%, #e8c86d 50%, #a07828 100%)",
            borderRadius: 8,
            boxShadow: "0 0 30px rgba(201,168,76,0.5)",
          }} />
          <div style={{ color: "#C9A84C", fontSize: "0.75rem", letterSpacing: "0.15em", textTransform: "uppercase" }}>
            Satin Gold Wrap
          </div>
        </div>
      </div>
      ...
      <div style={{ position: "absolute", bottom: 16, right: 16, color: "#C9A84C", fontSize: "0.7rem", letterSpacing: "0.1em", textTransform: "uppercase" }}>After</div>
    </div>
  );
}
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <button onClick={() => scrollTo("contact")} style={{
          ...
          onMouseEnter={e => { e.target.style.transform = "scale(1.04)"; e.target.style.boxShadow = "0 0 20px rgba(201,168,76,0.5)"; }}
      ...
      <section id="hero" style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 900 }}>
          ...
          <h1 style={{
            ...
            Wrap Beyond<br />
            <span style={{
              background: "linear-gradient(135deg, #C9A84C 0%, #e8c86d 40%, #a07828 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              backgroundClip: "text",
            }}>Expectations</span>
          ...
          <p style={{
            ...
            Premium Vehicle Wrapping, Paint Protection Film and Detailing.
          </p>
          ...
          <div style={{
            ...
            <button onClick={() => scrollTo("portfolio")} style={{
              ...
              onMouseEnter={e => { e.target.style.background = "#C9A84C"; e.target.style.transform = "scale(1.04)"; }}
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 900, textAlign: "center" }}>
          ...
          <ScrollReveal delay={0.25}>
            <p style={{
              ...
              lineHeight: 1.1,
              marginBottom: "3rem",
              color: storyProgress > 0.4 ? "#C9A84C" : "#222",
              transition: "color 0.5s ease",
            }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <ScrollReveal>
            <div style={{ textAlign: "center", marginBottom: "4rem" }}>
              <div style={{
                color: "#C9A84C", fontSize: "0.75rem", letterSpacing: "0.2em",
            ...
            <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap", marginBottom: "3rem" }}>
              <a href="mailto:hello@wraptech.com" style={{ textDecoration: "none" }}>
                <button style={{
                  ...
                  onMouseEnter={e => { e.target.style.transform = "scale(1.05)"; e.target.style.boxShadow = "0 0 60px rgba(201,168,76,0.5)"; }}
                  onMouseLeave={e => { e.target.style.transform = "scale(1)"; e.target.style.boxShadow = "0 0 40px rgba(201,168,76,0.3)"; }}
...
function PortfolioCard({ item }) {
  ...
  const patterns = [
    "radial-gradient(circle at 30% 70%, rgba(201,168,76,0.15) 0%, transparent 60%), linear-gradient(135deg, #111 0%, #1a1a1a 100%)",
    "radial-gradient(circle at 70% 30%, rgba(80,80,80,0.3) 0%, transparent 60%), linear-gradient(225deg, #0d0d0d 0%, #1a1a1a 100%)",
    "radial-gradient(ellipse at 50% 50%, rgba(201,168,76,0.1) 0%, transparent 70%), linear-gradient(90deg, #111 0%, #181818 100%)",
    "radial-gradient(circle at 20% 80%, rgba(60,60,60,0.4) 0%, transparent 60%), linear-gradient(180deg, #131313 0%, #0a0a0a 100%)",
    "radial-gradient(circle at 80% 20%, rgba(100,80,20,0.2) 0%, transparent 60%), linear-gradient(315deg, #0e0e0e 0%, #1c1c1c 100%)",
    "radial-gradient(ellipse at 40% 60%, rgba(30,30,30,0.8) 0%, transparent 70%), linear-gradient(45deg, #121212 0%, #1a1a1a 100%)",
  ];
...
function TestimonialCard({ testimonial }) {
  ...
  return (
    ...
    >
      <div style={{
        color: "#C9A84C", fontSize: "1.1rem", letterSpacing: "0.05em",
        marginBottom: "1.25rem",
