...
const SERVICES = [
  {
    icon: carWrap,
    title: "Εφαρμογές Αυτοκινήτου",
    desc: "Ολική – Μερική κάλυψη οχημάτων / Εσωτερική επένδυση αυτοκινήτου / Εφαρμογές μεμβρανών / Προστασία χρώματος",
    tag: "Popular",
    slug: "total-partial",
  },
 {
    ...
    desc: "Περιποίηση και βαφή ζαντών / Αξεσουάρ αυτοκινήτων",
    tag: "Detail",
    slug: "interior"
  },
  {
    ...
    desc: "Ασφάλεια κτηρίων / Εσωτερική επένδυση σπιτιού",  
    tag: "Spaces",
    slug: "ktirio"
  },
];
